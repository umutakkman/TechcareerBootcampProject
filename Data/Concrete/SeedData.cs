...
{
    public static void FillInitialData(IApplicationBuilder app)
    {
            ...
            try
            {
                ...
                if (!context.Users.Any())
                {
                    context.Users.AddRange(
                        new User
                        {
                            Username = "umutakman", Password = "umutakman", Email = "umutakman@gmail.com",
                            NameSurname = "Umut Akman"
                        },
                ...
                if (!context.Cars.Any())
                {
                    context.Cars.AddRange(
                        ...
                        new Car
                        {
                            ...
                            IsActive = true,
                            Categories = context.Categories
                                .Where(c => c.BrandCategory == "Mercedes-Benz" || c.TypeCategory == "Sedan" ||
                                            c.SeatCategory == 5)
                                .ToList()
                        },
                        new Car
                        {
                            ...
                            IsActive = true,
                            Categories = context.Categories
                                .Where(c => c.BrandCategory == "Toyota" || c.TypeCategory == "Sedan" ||
                                            c.SeatCategory == 5)
                                .ToList()
                        },
                        new Car
                        {
                            ...
                            IsActive = true,
                            Categories = context.Categories
                                .Where(c => c.BrandCategory == "Honda" || c.TypeCategory == "SUV" ||
                                            c.SeatCategory == 5)
                                .ToList()
                        },
                        new Car
                        {
                            ...
                            IsActive = true,
                            Categories = context.Categories
                                .Where(c => c.BrandCategory == "Ford" || c.TypeCategory == "Coupe" ||
                                            c.SeatCategory == 4)
                                .ToList()
                        },
                        new Car
                        {
                            ...
                            IsActive = true,
                            Categories = context.Categories
                                .Where(c => c.BrandCategory == "Chevrolet" || c.TypeCategory == "SUV" ||
                                            c.SeatCategory == 7)
                                .ToList()
                        },
                        new Car
                        {
                            ...
                            IsActive = true,
                            Categories = context.Categories
                                .Where(c => c.BrandCategory == "Porsche" || c.TypeCategory == "Coupe" ||
                                            c.SeatCategory == 2)
                                .ToList()
                        },
                        new Car
                        {
                            ...
                            IsActive = true,
                            Categories = context.Categories
                                .Where(c => c.BrandCategory == "Volkswagen" || c.TypeCategory == "SUV" ||
                                            c.SeatCategory == 5)
                                .ToList()
                        },
                        new Car
                        {
                            ...
                            IsActive = true,
                            Categories = context.Categories
                                .Where(c => c.BrandCategory == "Nissan" || c.TypeCategory == "Sedan" ||
                                            c.SeatCategory == 5)
                                .ToList()
                        },
                        new Car
                        {
                            ...
                            IsActive = true,
                            Categories = context.Categories
                                .Where(c => c.BrandCategory == "Tesla" || c.TypeCategory == "Sedan" ||
                                            c.SeatCategory == 5)
                                .ToList()
                        },
                        new Car
                        {
                            ...
                            IsActive = true,
                            Categories = context.Categories
                                .Where(c => c.BrandCategory == "Lamborghini" || c.TypeCategory == "Coupe" ||
                                            c.SeatCategory == 2)
                                .ToList()
                        },
                        new Car
                        ...
                        new Car
                        {
                            ...
                            IsActive = true,
                            Categories = context.Categories
                                .Where(c => c.BrandCategory == "Hyundai" || c.TypeCategory == "Sedan" ||
                                            c.SeatCategory == 5)
                                .ToList()
                        },
                        new Car
                        {
                            ...
                            IsActive = true,
                            Categories = context.Categories
                                .Where(c => c.BrandCategory == "Land Rover" || c.TypeCategory == "SUV" ||
                                            c.SeatCategory == 5)
                                .ToList()
                        }
                    );
